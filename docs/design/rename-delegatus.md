...
differed from this plan and what slice 1 did about it. Slice 4 is implemented;
§13 records the same for it. Counted at `main`
...
## 13. Slice 4: where the code differed from this plan
