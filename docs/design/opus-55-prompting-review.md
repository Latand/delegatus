...
The research proposal split these edits into two PRs. On 2026-09-24 the
operator approved proposals 1–9 in one PR with at most one review round, so
the implementation combines both groups below and bumps the mandate to v23.

Original proposed split:
