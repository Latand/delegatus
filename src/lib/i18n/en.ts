...
export const en = {
  ...
  "seatTick.row.lastWake": "Last wake",
  ...
  "seatTick.sentence.paused": "Off. No wake is sent; checks still run.",
  "seatTick.sentence.pausedSince": "Off since {age}. No wake is sent; checks still run.",
  ...
  "seatTick.stateUnreadable": "The tick's record could not be read: {error}",
  "seatTick.journalUnreadable": "The tick's journal could not be read: {error}",
