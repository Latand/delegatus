...
export const en = {
  ...
  "kanban.draft.noteAfter": "Nothing has been sent. {stage} starts when {after} passes, and this message is its first.",
  "kanban.draft.noteFirst": "Nothing has been sent. {stage} starts first, and this message is its first.",
  ...
  "kanban.draft.statusEnded": "Never delivered · the pipeline ended",
