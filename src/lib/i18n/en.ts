...
export const en = {
  ...
  "kanban.account.cancelUnknownNote": "The cancel may or may not have reached the server, and this page can't tell. Nothing more is sent from here; reloading the page ends this page's lock.",
