...
export const en = {
  ...
  "kanban.hiddenAria": { one: "{count} hidden task", other: "{count} hidden tasks" },
  "kanban.hiddenTitle": "Hidden tasks",
  "kanban.hiddenNote": "These tasks have nothing on the board and were taken off it. Their history stays; Show gives one a card again.",
  "kanban.hiddenEmpty": "Nothing is hidden.",
  ...
  "kanban.textFailedConflict": "Changed elsewhere",
