...
export const en = {
  ...
  "kanban.account.heldNote": "Messages sent meanwhile are held for the switch.",
  "kanban.account.noCancel": "Cancelling or changing a pending switch isn't available yet: the ways that exist today can cancel messages held for it.",
  "kanban.account.failedNote": "Retry it, or keep the current account, from the banner above the conversation.",
  "kanban.account.unknownNote": "It may be queued. This page won't send it again; the switch shows here once the server reports it.",
