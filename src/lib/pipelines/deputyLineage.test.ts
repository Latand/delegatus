...
test("a lane created by a live deputy has the seat as its creator", () => {
  expect(resolvePipelineCreatorLineage("/t/ghost.jsonl", ports)).toEqual({ lineage: { srcPath: "/t/seat.jsonl", srcConversationId: "conversation_seat" } });
});
