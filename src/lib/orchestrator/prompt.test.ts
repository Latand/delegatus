...
test("the default mandate is at version 18, and a v17 seat reads as stale", () => {
  expect(ORCHESTRATOR_PROMPT_VERSION).toBe(18);
  /* #1720, and again #1760 — a seat already running keeps the mandate it was
     ...
     in the task's separate details field. */
  expect(orchestratorMandateStale(17)).toBe(true);
  expect(orchestratorMandateStale(18)).toBe(false);
