...
const TOOL_DESCRIPTIONS: Record<McpToolName, string> = {
  ...
  board_snapshot: "Read a bounded, redacted snapshot of Delegatus board, durable placement, and the selected project's hidden conversation count.",
