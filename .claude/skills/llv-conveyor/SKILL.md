...
This section, and the tool it names, are about deploying **this** application — Agent Log Viewer, the one serving the board — and about no other project's release. The mandate carries none of it (#1760): a manager of somebody else's project reads its own project's release steps, not these.
